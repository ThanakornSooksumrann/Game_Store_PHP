            ...
            <div class="col-sm-2">
                ...
                <br/><br/>
                    <div class="row">
                        ...
                        <a href="DataUser.php" class="list-group-item list-group-item-action">ผู้ใช้ทั้งหมด</a>
                        <a href="InsertUser.php" class="list-group-item list-group-item-action list-group-item-secondary">เพิ่มผู้ใช้</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-12 mt-3 mb-3">
                            <h1><b><span class="badge badge-warning text-dark">เพิ่มผู้ใช้</span></b></h1>
                        </div>
                    </div>
